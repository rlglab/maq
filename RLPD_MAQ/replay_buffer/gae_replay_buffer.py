...
class GaeSampleMemory(object):
    ...
    class Trajectory(object):
        ...
        def merge(self, key):
            ...
            # redundant_count = len(merged_results) % self.episode_sequence_size
            # if redundant_count == 0:
            #     return merged_results
            # else:
            #     padding_count = self.episode_sequence_size - redundant_count
            #     if "key" == "reward":
            #         padding_content = 0
            #     else:
            #         padding_content = merged_results[0]
            #     merged_results = [padding_content] * padding_count + merged_results
            #     return merged_results
        ...
        def merge_observations(self, key):
            ...
            # else:
            #     padding_count = self.episode_sequence_size - redundant_count
            #     merged_results = [merged_results[0]] * padding_count + merged_results
            #     return merged_results
    ...
    def get_gae(self, index, discount_gamma, discount_lambda):
        ...
        for trajectory in self.paths[index].trajectories:
            ...
            if trajectory.transitions["done"][-1]:
                values.append(0)
                #values.append(rewards[-1])    # doesn't effect
            else:
