...
from RLPD_MAQ.RLPDMAQ import MAQDRLPDSACAgent
import time
# MAQRLPD
class RLPDMAQAgent(AbstractAgent):
    save_time = False
    time_csv = "RLPDMAQ_time.csv"
    ...
    def inference(self, state):
        ...
        if self.save_time:
            print(f"RLPDMAQ decide_agent_actions time: {policy_time} seconds")
            print(f"RLPDMAQ decoded_primitive_actions time: {vqvae_time} seconds")
